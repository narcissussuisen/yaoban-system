...
TASK_NAMES = [
    ...
    "EvoAlphaPremarket",
    "EvoAlphaPlanGate",
    "EvoAlphaMorningCheck",
    "EvoAlphaTdxProbe",
    "EvoAlphaAuctionMonitor",
    "EvoAlphaEventNotify",
    "EvoAlphaTickDaemon",
    "EvoAlphaScanConfirm",
    "EvoAlphaIntradayMonitor",
    "EvoAlphaClosePipeline",
    "EvoAlphaPostCloseChain",
    "EvoAlphaEveningCheck",
    "EvoAlphaTdxServerVerify",
    "EvoAlphaBoardRefresh",
    "EvoAlphaStatusPush",
