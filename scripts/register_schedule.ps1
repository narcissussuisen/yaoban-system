...
$Schedule = @(
    @{ Name = "EvoAlphaPreflight";          Mode = "infra";          At = @("08:35");          Limit = "PT30M"; Restart = "3xPT1M"; Enabled = $true;  Desc = "EvoAlpha infra preflight gate" },
    @{ Name = "EvoAlphaSelfHeal";           Mode = "selfheal";       At = @("08:36");          Limit = "PT20M"; Enabled = $true;  Desc = "EvoAlpha pre-open self-heal (restart/data repairs only)" },
    @{ Name = "EvoAlphaPremarket";          Mode = "premarket";      At = @("08:50");          Limit = "PT30M"; Restart = "3xPT1M"; Enabled = $true;  Desc = "EvoAlpha premarket snapshot" },
    @{ Name = "EvoAlphaPlanGate";           Mode = "plan-gate";      At = @("08:55");          Limit = "PT30M"; Restart = "3xPT1M"; Enabled = $true;  Desc = "EvoAlpha plan acceptance gate" },
    @{ Name = "EvoAlphaMorningCheck";       Mode = "morning-check";  At = @("08:58");          Limit = "PT2M";  Enabled = $true;  Desc = "EvoAlpha single pre-open selfcheck card" },
    @{ Name = "EvoAlphaTdxProbe";           Mode = "tdx-probe";      At = @("09:00");          Limit = "";      Interval = "PT30M"; Duration = "PT7H"; Enabled = $true; Desc = "EvoAlpha TDX recovery probe" },
    @{ Name = "EvoAlphaAuctionMonitor";     Mode = "auction";        At = @("09:15");          Limit = "PT5M";  Interval = "PT1M";  Duration = "PT15M"; Enabled = $true; Desc = "EvoAlpha auction observer (read-only)" },
    @{ Name = "EvoAlphaEventNotify";        Mode = "notify";         At = @("09:15");          Limit = "PT5M";  Interval = "PT1M";  Duration = "PT5H46M"; Enabled = $true; Desc = "EvoAlpha intraday event notify" },
    ...
    @{ Name = "EvoAlphaTickDaemon";         Mode = "tick";           At = @("09:30");          Limit = "PT6H20M"; Restart = "3xPT1M"; Enabled = $true; Desc = "EvoAlpha tick risk daemon (gate-independent; covers 15:05-15:30 after-hours window)" },
    @{ Name = "EvoAlphaScanConfirm";        Mode = "scan";           At = @("09:30");          Limit = "PT10M"; Interval = "PT1M";  Duration = "PT5H31M"; Enabled = $true; Desc = "EvoAlpha full-market scan (T2)" },
    @{ Name = "EvoAlphaIntradayMonitor";    Mode = "monitor";        At = @("09:30");          Limit = "PT10M"; Interval = "PT1M";  Duration = "PT5H31M"; Enabled = $true; Desc = "EvoAlpha intraday monitor" },
    @{ Name = "EvoAlphaClosePipeline";      Mode = "close";          At = @("15:10");          Limit = "PT30M"; Restart = "3xPT1M"; Enabled = $true;  Desc = "EvoAlpha close pipeline" },
    @{ Name = "EvoAlphaPostCloseChain";     Mode = "post-close";     At = @("15:35");          Limit = "PT3H";  Restart = "2xPT5M"; Enabled = $true; Desc = "EvoAlpha post-close chain (rebuild/r5p/r6p/plan/acceptance/log-review)" },
    @{ Name = "EvoAlphaEveningCheck";       Mode = "evening-check";  At = @("17:30");          Limit = "PT15M"; Enabled = $true;  Desc = "EvoAlpha evening verification card" },
    @{ Name = "EvoAlphaTdxServerVerify";    Mode = "tdx-verify";     At = @("10:00"); Days = @("Saturday"); Limit = ""; Enabled = $true; Desc = "Weekly TDX server liveness + calendar refresh" },
    @{ Name = "EvoAlphaBoardRefresh";       Script = "run_board_refresh.ps1"; At = @("09:35", "13:05"); Limit = "PT3M"; Interval = "PT3M"; Duration = "PT1H51M"; Enabled = $true; Desc = "EvoAlpha board snapshot refresh" },
    ...
    @{ Name = "EvoAlphaStatusPush";         Script = "run_status_push.ps1"; At = @("08:36", "08:50", "08:55", "09:00", "09:30", "09:35", "11:30", "13:05", "13:10", "15:05", "15:40", "17:45", "18:30"); Limit = "PT3M"; Interval = "PT5M"; Duration = "PT4H"; Enabled = $true; Desc = "EvoAlpha key-node status cards (read-only observer)" },
...
if (-not $VerifyOnly) {
    foreach ($e in $Schedule) {
        ...
        Register-ScheduledTask -TaskName $e.Name -Action (New-EvoAlphaAction $e) -Trigger $triggers `
